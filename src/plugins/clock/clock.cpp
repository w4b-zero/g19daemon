...
void Clock::paint() {
  if (isActive) {
    ...
    QPainter *p;
    static const QPoint hourHand[4] = {QPoint(-4, 0), QPoint(-1, -50),
                                       QPoint(1, -50),QPoint(4, 0)};
    static const QPoint minuteHand[4] = {QPoint(-4, 0), QPoint(-1, -70),
                                         QPoint(1, -70),QPoint(4, 0)};
    static const QPoint secondHand[4] = {QPoint(-4, 0), QPoint(-1, -96),
                                         QPoint(1, -96),QPoint(4, 0)};
    ...
    QLinearGradient clock_bg(0, 0, 0, 240);
...
glass.setColorAt(1, QColor(192, 192, 192));
    ...
    clock_bg.setColorAt(0, qRgb(0, 0, 0));
    clock_bg.setColorAt(1, qRgb(0, 115, 153));
